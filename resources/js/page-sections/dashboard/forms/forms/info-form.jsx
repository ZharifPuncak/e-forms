...
const InfoForm = ({ data })  => {
  ...
  <form onSubmit={handleSubmit}>
        ...
        <Grid container={true} spacing={4}  >
            ...
            <Grid  size={{xs : 12, sm: 12, md : 6 }}>
             <Chip sx={{ mb : 1 }} label={'Category'} color='soft'/>
              <Stack spacing={1}>
                 <Autocomplete
          ...
          <Grid  size={{xs : 12, sm: 12, md : 6 }}>
             <Chip sx={{ mb : 1 }} label={'Type'} color='soft'/>
              <Stack spacing={1}>
                  <Autocomplete
                  sx={{
                    "& .MuiInputBase-root": { height: 45 }, // Adjust input height
            ...
            <Chip sx={{ mb : 1 }} label={'Description'} color='soft'/>
                  <TextEditor
                          content={""}
                          onUpdate={({ editor }) => {
                            // editor.getText()
          	...
          	<Grid size={{xs : 12, sm: 12, md : 12 }}> 
                  <Chip sx={{ mb : 1 }} label={'Instructions'} color='soft'/>
                  <TextEditor
                          content={""}
                          onUpdate={({ editor }) => {
                            // editor.getText()
