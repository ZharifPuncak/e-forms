...
<p>This is an annoucement that the <strong>{{ form_name }}</strong> requires your acknowledgment. Your confirmation is essential to ensure compliance and proper record-keeping.</p>
...
<ol>
    ...
    <li>Sign and submit your acknowledgment for PDPA by <strong>{{ deadline }}</strong>.</li>
</ol>
